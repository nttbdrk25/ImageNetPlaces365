...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=None, init_weights=True):
...
def vgg11(num_classes=None,pretrained=False, **kwargs):
...
def vgg11_bn(num_classes=None,pretrained=False, **kwargs):
...
def vgg13(num_classes=None,pretrained=False, **kwargs):
...
def vgg13_bn(num_classes=None,pretrained=False, **kwargs):
...
def vgg16(num_classes=None,pretrained=False, **kwargs):
...
def vgg16_bn(num_classes=None,pretrained=False, **kwargs):
...
def vgg19(num_classes=None,pretrained=False, **kwargs):
...
def vgg19_bn(num_classes=None,pretrained=False, **kwargs):
